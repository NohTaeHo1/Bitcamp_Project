...
import com.bangez.gateway.handler.CustomAuthenicationFailureHandler;
...
public class WebSecurityConfig {
    ...
    public CorsConfigurationSource configurationSource() {
        ...
        config.setAllowedOriginPatterns(List.of("http://localhost:3000", "https://www.taeho.site", "http://www.taeho.site"));
