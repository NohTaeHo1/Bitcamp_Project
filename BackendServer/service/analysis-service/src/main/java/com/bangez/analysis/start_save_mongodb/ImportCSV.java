...
//        System.out.println("Current directory: " + currentDir);
        ...
        CSVReader reader = new CSVReader(new FileReader("service/analysis-service/src/main/java/com/bangez/analysis/common/static_data/school.csv"));
...
//
        CSVReader reader2 = new CSVReader(new FileReader("service/analysis-service/src/main/java/com/bangez/analysis/common/static_data/officetel_trade.csv"));
        ...
        CSVReader reader3 = new CSVReader(new FileReader("service/analysis-service/src/main/java/com/bangez/analysis/common/static_data/officetel_rent.csv"));
        ...
        CSVReader reader4 = new CSVReader(new FileReader("service/analysis-service/src/main/java/com/bangez/analysis/common/static_data/city_park.csv"));
        ...
        CSVReader reader5 = new CSVReader(new FileReader("service/analysis-service/src/main/java/com/bangez/analysis/common/static_data/apt_trade.csv"));
        ...
        CSVReader reader6 = new CSVReader(new FileReader("service/analysis-service/src/main/java/com/bangez/analysis/common/static_data/apt_rent.csv"));
